...
let known_issues = 'project = "Couchbase Server" AND fixVersion = vulcan AND labels = releasenote AND (level is EMPTY OR level not in (Private,Playdom,Zynga) ) AND affectedVersion !=  vulcan'

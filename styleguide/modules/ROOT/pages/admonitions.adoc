...
WARNING: Dropping a bucket is an irreversible action.
You cannot recover the data from a dropped bucket. 
...
CAUTION: *Memcached* buckets are deprecated.
Use a *Couchbase* or *Ephemeral* bucket, instead.

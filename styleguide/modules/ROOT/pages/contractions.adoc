...
Contractions are combinations of at least 2 words. 
A contraction is made by omitting 1 or more letters from 1 word and adding it to the end of another word. 

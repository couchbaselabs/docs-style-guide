...
You cannot do anything else in the application until you close the dialog. 
...
* Use the title of the dialog as it appears in the UI, where possible.
This includes matching capitalization.

* Bold the dialog name.
Do not bold the word "dialog." 

...
+
If the concept topic is a basic, introductory guide to the UI, then consider adding 1 screenshot to show the UI, when a textual explanation would be too long or insufficient.

...
Pages are the whole of what's displayed in the UI to the user.
They contain xref:buttons.adoc[], xref:tabs.adoc[], and other UI elements.
...
* If you're describing a page for the purposes of navigation, see xref:tabs.adoc[] and xref:menus.adoc[]. 
+

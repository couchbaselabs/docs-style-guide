...
For more information about how to format an unordered list in Antora, see https://docs.couchbase.com/home/contribute/basics.html#unordered-lists[Unordered Lists] in the Contributing to the Documentation guide.
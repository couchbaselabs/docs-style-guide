...
| [[cluster]]cluster | If referring to Couchbase Server or Couchbase Capella operational databases, use <<database,database>>, instead. Use cluster whenever you're referring to an instance of Couchbase Columnar. 
...
| Couchbase Capella | "Couchbase Cloud" or "Couchbase Managed Cloud" in legacy documentation. Use "operational database" if you need to specify which type of Capella instance, as opposed to Columnar. Write as *Couchbase Capella* + *operational database* for the first use on a page. Follow the official capitalization as set by Couchbase. For more information, see xref:capitalization.adoc[].
...
| Couchbase Columnar | Write as *Capella Columnar Services* for the first use on a page. Use just *Columnar* for any subsequent uses. Refer to specific instances of Columnar as <<cluster,clusters>>, as opposed to the Couchbase Capella operational database. 
...
| [[database]]database | Preferred term for Capella operational. Don't use <<cluster,cluster>> unless necessary. Do not capitalize when referring to a database in Capella Columnar.
...
| operational database | Use when referring to a Couchbase Capella database, as opposed to a Capella Columnar cluster.

...
| [[cluster]]cluster | If referring to Couchbase Server or Couchbase Capella operational databases, use <<database,database>>, instead. Use cluster whenever you're referring to Couchbase Columnar instances. 

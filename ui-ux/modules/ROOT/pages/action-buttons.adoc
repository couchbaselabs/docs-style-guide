...
NOTE: This is unnecessary if the action button is a navigation button.
Name the page that the user navigates to, instead, or use navigation words like `Next` or `Back`.
...
Try to make the action match the surrounding text.

            ...
            <div className="container">
              <div className="col-two">
                <div className="intro-content">
                  ...
                  <Link to="/tutorials/travel-sample/develop/swift" className=" hyperlink-effect">Swift</Link><br/><br/>
                  <Link to="/tutorials/travel-sample/develop/java" className=" hyperlink-effect">Java</Link><br/><br/>
                  <Link to="/tutorials/travel-sample/develop/csharp" className=" hyperlink-effect">C Sharp</Link>
                </div>
              </div>
